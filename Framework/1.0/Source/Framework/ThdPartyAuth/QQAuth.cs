...
{
    public class QQAuth : OAuthThdPartyAuth
    {
        private static string consumerKey = ConfigurationManager.AppSettings["QQAppKey"];
        private static string consumerSecret = ConfigurationManager.AppSettings["QQAppSecret"];
        private static string requestToken = ConfigurationManager.AppSettings["QQRequestToken"];
        private static string authorize = ConfigurationManager.AppSettings["QQAuthorize"];
        private static string accessToken = ConfigurationManager.AppSettings["QQAccessToken"];
        private static string userInfoUrl = ConfigurationManager.AppSettings["QQUserInfoUrl"];
        public QQAuth(IUserManager userManager, IThirdPartyAuthenticationManager thdPartAuthManager, string callbackUrl)
            : this(userManager, thdPartAuthManager, callbackUrl, "")
        {
        }
        public QQAuth(IUserManager userManager, IThirdPartyAuthenticationManager thdPartAuthManager, string callbackUrl, string tokenSecret)
