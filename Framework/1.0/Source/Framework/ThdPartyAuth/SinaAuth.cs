...
{
    public class SinaAuth : OAuthThdPartyAuth
    {
        private static string consumerKey = ConfigurationManager.AppSettings["SinaAppKey"];
        private static string consumerSecret = ConfigurationManager.AppSettings["SinaAppSecret"];
        private static string requestToken = ConfigurationManager.AppSettings["SinaRequestToken"];
        private static string authorize = ConfigurationManager.AppSettings["SinaAuthorize"];
        private static string accessToken = ConfigurationManager.AppSettings["SinaAccessToken"];
        private static string userInfoUrl = ConfigurationManager.AppSettings["SinaUserInfoUrl"];
        public SinaAuth(IUserManager userManager, IThirdPartyAuthenticationManager thdPartAuthManager, string callbackUrl)
            : this(userManager, thdPartAuthManager, callbackUrl, "")
        {
        }
        public SinaAuth(IUserManager userManager, IThirdPartyAuthenticationManager thdPartAuthManager, string callbackUrl, string tokenSecret)
