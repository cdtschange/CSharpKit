...
namespace Cdts.Framework
{
    public sealed class ValidationFactory
    {
                ...
                if (container == null)
                {
                    lock (containerlock)
                    {
                        if (container == null)
                        {
                            ...
                            section.Configure(container, "Validation");
                        }
                    }
                }
                return container;
        ...
        {
            return Container.Resolve<IValidation>();
        }
        public static IValidation Create(string name)
        {
            return Container.Resolve<IValidation>(name);
        }
    }
}
